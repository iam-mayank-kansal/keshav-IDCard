...
export default function IDCard() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <section id="idCard" className="border-2 p-1 border-green-500 h-fit mt-5">
            ...
            return (
              <div className="flex gap-10 border-2 border-black p-2 bg-white particularIDCard" key={index} >
                ...
                <div className="w-[639px] h-[1011px] bg-white rounded-lg shadow-xl overflow-hidden border-4 border-purple-800">
                  ...
                  {/* Front Side */}
                  <div className="w-full h-full bg-white flex flex-col cursor-pointer relative rounded-lg">
                    {/* College header */}
                      ...
                      <div className="flex flex-col items-center text-center mb-6">
                        ...
                        <div className="">
                          <div className="border-2 border-purple-600 rounded-md overflow-hidden shadow-md">
                            <img src="/defaultimage.png" alt="" className="object-center object-cover w-full h-[355px]" />
                          </div>
                        </div>
                        ...
                        <div className="pl-4 flex flex-col justify-center">
                          ...
                          <p className="text-[26px] font-semibold text-purple-800 mb-2">{user.course}</p>
                    ...
                    {/* Footer */}
                    <div className="bg-purple-800 py-2 px-6  w-full text-white text-center ">
                      <p className="text-[18px]">
                        {user.batch}
                      </p>
                      <p className="text-[18px]">issued : ${user.issueDate} | valid Upto : ${user.validityDate} </p>
                    </div>
